...
EXPERIMENT_NAME = "merchant-churn-retraining"
...
def main() -> None:
    ...
    with mlflow.start_run(
        run_name="drift-triggered-retraining"
    ):
        mlflow.log_params(
            {
                "model_type":
    ...
    print(
        f"New candidate version: "
        f"{newest_version.version}"
    )

    print(
        "Candidate alias assigned successfully"
    )
